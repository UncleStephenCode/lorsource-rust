...
| covered | `ANY` | `/forum/{group}/{year}/{month}` | `GroupController.forumArchive` | `GET /forum/:group/:year/:month` |
...
| covered | `ANY` | `/resolve.jsp` | `ResolveController.resolve` | `POST /resolve.jsp` |
...
| covered | `GET` | `/{section}/{group}/{id}/page{page}` | `TopicController.getMessagePage` | `GET /forum/:group/:id/page/:page` |
