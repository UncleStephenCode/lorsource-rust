...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/forum/:group", get(groups::group_page).post(groups::group_page))
        .route("/forum/:group/archive", get(groups::group_archive))
        .route("/forum/:group/:id", get(topics::topic_page))
        .route("/forum/:group/:id_or_year/:page_or_month", get(legacy::forum_page_or_archive))
        ...
        .route("/news/:group/:id/:page_marker", get(topics::topic_page_with_page))
        ...
        .route("/articles/:group/:id/:page_marker", get(topics::topic_page_with_page))
        ...
        .route("/gallery/:group/:id/:page_marker", get(topics::topic_page_with_page))
        ...
        .route("/polls/:group/:id/:page_marker", get(topics::topic_page_with_page))
        ...
        .route("/people/:nick/reactions/:mode", get(users::reactions_mode))
        ...
        .route("/forum/:group/:id/thread/:thread_root", get(topics::topic_thread))
        .route("/news/:group/:id/thread/:thread_root", get(topics::topic_thread))
        .route("/articles/:group/:id/thread/:thread_root", get(topics::topic_thread))
        .route("/gallery/:group/:id/thread/:thread_root", get(topics::topic_thread))
        .route("/polls/:group/:id/thread/:thread_root", get(topics::topic_thread))
        .merge(admin::router())
}
