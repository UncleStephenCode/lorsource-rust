...
| partial-method | `ANY` | `/{section}/` | `` | `TopicListController.topics` | `GET /forum; GET /forum/; GET /news; GET /news/; GET /polls; GET /polls/; GET /articles; GET /articles/; GET /gallery; GET /gallery/` |
