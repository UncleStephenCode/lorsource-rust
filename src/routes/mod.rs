...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/forum/{group}/{id}/{tail}", get(legacy::forum_page_or_archive))
        ...
        .route("/news/{group}/{id}/{tail}", get(topics::topic_page_with_page))
        ...
        .route("/articles/{group}/{id}/{tail}", get(topics::topic_page_with_page))
        ...
        .route("/gallery/{group}/{id}/{tail}", get(topics::topic_page_with_page))
        ...
        .route("/polls/{group}/{id}/{tail}", get(topics::topic_page_with_page))
        ...
        .route("/forum/{group}/{id}/{tail}/history", get(legacy::comment_history))
        .route("/news/{group}/{id}/history", get(legacy::topic_history))
        .route("/news/{group}/{id}/{tail}/history", get(legacy::comment_history))
        .route("/articles/{group}/{id}/history", get(legacy::topic_history))
        .route("/articles/{group}/{id}/{tail}/history", get(legacy::comment_history))
        .route("/gallery/{group}/{id}/history", get(legacy::topic_history))
        .route("/gallery/{group}/{id}/{tail}/history", get(legacy::comment_history))
        .route("/polls/{group}/{id}/history", get(legacy::topic_history))
        .route("/polls/{group}/{id}/{tail}/history", get(legacy::comment_history))
